...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        [SerializeField] private float cameraOffsetZ = 1; // the smoothing for the camera's rotation
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            transform.position = Vector3.Lerp(transform.position, m_Target.position + m_Target.forward *cameraOffsetZ +new Vector3(0,2,0), deltaTime*m_MoveSpeed);
